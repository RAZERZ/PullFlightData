...
This isn't needed since the json file is static
-->
...
* The above code is not needed since we're using a local file and not connecting to the api
*/

        $queryResultJsonDecode = json_decode(file_get_contents("./AirportBoards.json"), true); //Sets the local json file
